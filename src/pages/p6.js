...
const p6 = () => (
  <div>
  <div className="nav6">
   <a href="#61" id="n1" >简介</a>
   <a href="#62" id="n2" >设计背景</a>
   <a href="#63" id="n3" >设计分析</a>
   <a href="#64" id="n4" >方案对比</a>
   <a href="#65" id="n5" >最终方案</a>
 </div>
 <div className="content6">
 <a name="61"></a> <h1>真时4G智能手表</h1>
  <div className="简介6">
 ...
 <p id="简介内容6">随着科技发展和4G时代的到来，智能手表不断发展，逐渐脱离其他电子设备独立使用。真时科技希望在现有产品功能的基础上研发设计一款4G智能手表，这款手表可以独立通信，并且相比公司原来的产品具备更多更完善的功能。独立通信手表面临着一个挑战：如何让用户在小小的表盘中高效地完成任务。</p>
  ...
  <a name="64"></a><img  src={require('../image/路径短.png')} />
