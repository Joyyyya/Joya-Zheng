...
const p1 = () => (
 ...
 <a name="11"></a> <h1>SenseHi 刷脸打卡动效设计</h1>
  <div className="简介1">
   <img  src={require('../image/首图.png')}/>
  <p id="简介1">简介</p>
 <p id="简介内容1">SenseHi是基于公司研发的人脸识别技术，商汤内部员工刷脸打卡考勤软件。打卡软件讲究效率，而改版前的刷脸动效不够顺畅，整体动效迟缓，影响打卡体验。我刷脸打卡的流程进行分析，在原有的动效基础上进行改进，提高刷脸打卡的效率和整体体验。</p>
  <p id="时间1">时间</p>
  ...
  <a name="12"></a><p id="角色和工作内容1">交互设计师负责刷脸打卡动效设计</p>
   ...
   <h1>01</h1>
   <h2>设计背景</h2>
   <img  src={require('../image/改版前.gif')}/>
   <img  src={require('../image/设计背景.png')}/>
  </div>
  <div className="设计分析1">
  ...
  <img   src={require('../image/改版前1.png') }  />
  <img   src={require('../image/改版前2.png') }  />
  <img   src={require('../image/改版前3.png') }  />
  ...
  <h3>1.进入界面过渡</h3>
  <img  id="放大" src={require('../image/放大.gif') }  width="230px"/>
  <img  id="模糊" src={require('../image/模糊.gif') }  width="230px"/>
  <img  id="绽放" src={require('../image/绽放.gif') }  width="230px"/>
  <p id="方案一">方案一：遮罩蒙版放大进入</p>
  <p id="方案二">方案二：模糊过渡</p>
  <p id="方案三">方案三：打卡按钮上升放大像烟花一样绽开</p>
  <img  id="缩小" src={require('../image/缩小.gif') }  width="230px"/>
  ...
  <h4>2.loading</h4>
  <img  id="大" src={require('../image/大圈loading.gif') }  width="230px"/>
  <img  id="小" src={require('../image/小圈loading.gif') }  width="230px"/>
  ...
  <h5>3.成功反馈</h5>
  <img  id="弹窗" src={require('../image/成功弹窗.gif') }  width="230px"/>
  <img  id="打钩" src={require('../image/打钩.gif') }  width="230px"/>
  ...
  <h6>4.返回首页过渡</h6>
  <img  id="上升" src={require('../image/上升.gif') }  width="230px"/>
  <img  id="卡片" src={require('../image/卡片.gif') }  width="230px"/>
  <img  id="时间" src={require('../image/时间变化.gif') }  width="230px"/>
  ...
  <p id="最终1">5.最终方案</p>
  <img  id="打卡动效" src={require('../image/最终.gif') }  width="230px"/>
  <img  id="动效文档" src={require('../image/动效文档.png') }  width="650px"/>
  <p id="方案">最终方案</p>
  <p id="文档">动效文档</p>
  <a name="15"></a>
  </div >
