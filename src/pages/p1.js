...
const p1 = () => (
  <div>
      ...
      <a name="1"></a> <h1>SenseHi 刷脸打卡动效设计</h1>
       <div className="简介">
        <img  src={require('../image/首图.png')}/>
       <p id="简介">简介</p>
      <p id="简介内容">SenseHi是基于公司研发的人脸识别技术，商汤内部员工刷脸打卡考勤软件。打卡软件讲究效率，而改版前的刷脸动效不够顺畅，整体动效迟缓，影响打卡体验我对刷脸打卡的流程进行分析，在原有的动效基础上进行改进，提高刷脸打卡的效率和整体体验。</p>
       <p id="时间">时间</p>
       <p id="时间内容">2019/04-2019/06</p>
       <p id="角色和工作">角色和工作</p>
       <a name="2"></a><p id="角色和工作内容">交互设计师负责刷脸打卡动效设计</p>
       </div>
        <div className="设计背景">
        <h1>01</h1>
        <h2>设计背景</h2>
